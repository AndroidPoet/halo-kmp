 ...
 * implements this interface (the shipped `LiveActivitiesBridge.swift` forwards to
 * the `LiveActivitiesKMP` Swift package) and registers it with
 * [LiveActivities.register] at launch.
 *
