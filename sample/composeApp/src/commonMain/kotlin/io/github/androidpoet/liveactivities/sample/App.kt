...
import io.github.androidpoet.liveactivities.LiveActivityAuthorization
import io.github.androidpoet.liveactivities.compose.rememberLiveActivityManager
...
fun App() {
    MaterialTheme {
        ...
        Column(
            ...
            Text("Live Activities KMP", style = MaterialTheme.typography.headlineMedium)
