...
/// `ActivityConfiguration(for: KmpLiveActivityAttributes.self)` instead when you
/// want a custom look.
@available(iOS 16.2, *)
public struct KmpLiveActivityWidget: Widget {
    public init() {}
...
struct KmpLockScreenView: View {
    let state: KmpLiveActivityAttributes.ContentState
    let isStale: Bool
